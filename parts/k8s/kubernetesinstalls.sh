...
function installMoby() {
    ...
    retrycmd_if_failure 20 1 5 curl -L "https://azurek8scishared.blob.core.windows.net/shared/moby-engine_3-az-09f5e9d_amd64.deb?sp=r&st=2018-10-15T18:00:00Z&se=2019-01-01T03:46:55Z&spr=https&sv=2017-11-09&sig=7nMY9QlLDN%2F7jXyUoXuczikHMuPEFO%2BiVGrFuMuM5%2F0%3D&sr=b" > /tmp/moby-engine_3-az-09f5e9d_amd64.deb
    retrycmd_if_failure 20 1 5 dpkg -i /tmp/moby-engine_3-az-09f5e9d_amd64.deb
    apt_get_update || exit $ERR_APT_UPDATE_TIMEOUT
